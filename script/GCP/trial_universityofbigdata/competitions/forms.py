...
class CompetitionPostChangeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('post','team_tag','user_tag','post_key','count_par_today',)

class CompetitionModelChangeForm(forms.ModelForm):
    """
    情報表示用フォーム
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['problem_type'].widget.attrs['disabled'] = 'disabled'
        self.fields['evaluation_type'].widget.attrs['disabled'] = 'disabled'
        self.fields['status'].widget.attrs['disabled'] = 'disabled'
        self.fields['open_datetime'].widget.attrs['disabled'] = 'disabled'
        self.fields['close_datetime'].widget.attrs['disabled'] = 'disabled'
        self.fields['public'].widget.attrs['disabled'] = 'disabled'
        self.fields['invitation_only'].widget.attrs['disabled'] = 'disabled'
